## v1.0
# Generated by Powerlevel10k configuration wizard on 2023-01-03 at 00:09 CET.
...
() {
  ...
  function instant_prompt_lastscreenshot() {
    cat $HOME/bin/last_screenshot.last
  }
